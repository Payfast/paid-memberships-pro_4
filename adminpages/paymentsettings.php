...
?>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<tbody>
			...
			<tr class="gateway gateway_ <?php echo esc_attr(pmpro_getClassesForPaymentSettingsField("currency"));?> gateway_payfast" <?php if(!empty($gateway) && $gateway != "paypal" && $gateway != "paypalexpress" && $gateway != "paypalstandard" && $gateway != "braintree" && $gateway != "twocheckout" && $gateway != "cybersource" && $gateway != "payflowpro" && $gateway != "stripe" && $gateway != "authorizenet" && $gateway !='payfast') { ?>style="display: none;"<?php } ?>>
				<th scope="row" valign="top">
